<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuDynamicExample.aspx.cs" Inherits="ASPNetDemoExample1.NavigationControlDemos.MenuDynamicExample" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" OnMenuItemClick="Menu1_MenuItemClick" StaticSubMenuIndent="10px" DataSourceID="XmlDataSource1">
                <DataBindings>
